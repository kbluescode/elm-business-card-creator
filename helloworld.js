...
var author$project$Main$init = {color: 'is-dark', description: 'Attorney at Law.', phone_number: '(555) 555-5555', title: 'Derp Derpington'};
...
var author$project$Main$UpdatePhoneNum = function (a) {
	return {$: 'UpdatePhoneNum', a: a};
};
...
var author$project$Main$changeForm = A2(
	elm$html$Html$form,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$Main$heroPane = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('title'),
				elm$html$Html$Attributes$class('hero is-centered is-bold ' + model.color)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('has-text-centered title is-1')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('has-text-centered title is-3')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(model.phone_number)
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('has-text-centered subtitle')
					]),
				_List_fromArray(
					[
